...
<figure class="mdc-card demo-card w-full md:max-w-3x1 float-inital">
  <div class="mdc-card__primary-action demo-card__primary-action" tabindex="0">
    ...
    <div class="demo-card__secondary mdc-typography mdc-typography--body2 p-4">Visit ten places on our planet that are undergoing the biggest changes today.</div>
  </div>
