<script>
export let name = 'small';
</script>

<figure class="mdc-card demo-card w-full md:max-w-3x1 sm:w-full my-4 md:max-w-4xl">
  <div class="mdc-card__primary-action demo-card__primary-action" tabindex="0">
    <div class="mdc-card__media mdc-card__media--16-9 demo-card__media sm:w-full" style="background-image: url(&quot;https://collabtube-encoded-east1.s3.amazonaws.com/{name}.gif&quot;);"></div>
